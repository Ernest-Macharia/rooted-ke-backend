...
class Event(models.Model):
    ...
    media_asset = models.ForeignKey('core.MediaAsset', null=True, blank=True, on_delete=models.SET_NULL, related_name='events')
    lineup = models.JSONField(default=list, blank=True)
    tips = models.JSONField(default=list, blank=True)
    tags = models.JSONField(default=list, blank=True)
    gallery = models.JSONField(default=list, blank=True)
    gallery_assets = models.ManyToManyField('core.MediaAsset', related_name='event_galleries', blank=True)
