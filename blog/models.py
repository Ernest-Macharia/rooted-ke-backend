...
class BlogPost(models.Model):
    ...
    featured_media_asset = models.ForeignKey('core.MediaAsset', null=True, blank=True, on_delete=models.SET_NULL, related_name='blog_posts')
    ...
    author_avatar_media_asset = models.ForeignKey('core.MediaAsset', null=True, blank=True, on_delete=models.SET_NULL, related_name='blog_author_avatars')
