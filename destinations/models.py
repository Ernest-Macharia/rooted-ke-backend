...
class Destination(models.Model):
    ...
    display_tags = models.JSONField(default=list, blank=True)
    package_link = models.CharField(max_length=255, blank=True)
    hotel_search = models.CharField(max_length=255, blank=True)
